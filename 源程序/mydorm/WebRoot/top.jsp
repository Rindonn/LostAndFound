...
<table width="1024" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    </span></td><td width="443" align="left" valign="bottom" background="img/bg_titlebarr.gif" class="STYLE1" style="border-bottom:1px solid #9EC3F2">
	<span onclick="javasciprt:modipass();" style="cursor:hand;">[修改个人密码]</span> <span onclick="javasciprt:exit();" style="cursor:hand;">[退出系统]</span> <span onclick="javasciprt:indexweb();" style="cursor:hand;">[返回主页]</span>
	</td>
  </tr>
</table>
</body>
