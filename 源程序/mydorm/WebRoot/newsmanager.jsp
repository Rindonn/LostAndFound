...
<table width="829" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#9EC3F2" style="font-size:12px">
  <!--DWLayoutTable-->
  <tr>
    <td height="25" colspan="5" align="left" valign="middle" background="img/bg_titlebarr.gif"><span class="STYLE1">招领信息管理[<a href="addnews.jsp">新增信息</a>]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> </td>
  </tr>
  <tr>
 ...
 news n=new news();
  ...
  <tr>
    ...
    <td align="center" valign="middle" bgcolor="#F9FCFF"><span class="STYLE4">
    <a href="newsop.jsp?op=del&bh=<%=n.getBh()%>">删除</a>&nbsp;&nbsp;
    <%if("10".equals(n.getZt())){%>
				<a href="newsop.jsp?op=sh&bh=<%=n.getBh()%>">审核</a>&nbsp;&nbsp;
	    <%}%>
