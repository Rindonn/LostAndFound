      ...
      <tr>
        <td height="27"><TABLE id=Table3 cellSpacing=0 cellPadding=0 width="97%" 
          ...
          <TBODY>
            ...
            <TR>
              <TD width="76%" height=6><form action="morenews4.jsp">关键字：<input type="text" size="50" name="ss"/> <input type="submit" value="搜索"/></form></TD>
            </TR>
            <%
